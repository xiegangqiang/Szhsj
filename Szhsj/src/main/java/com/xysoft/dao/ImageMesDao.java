...
public interface ImageMesDao extends BaseDao<ImageMes> {
	 ...
	 * 获取图文列表(分类).
	 */
	public Pager<ImageMes> getImageMess(String wxid, Integer count, String classify);
	
	/**
	 * 获取图文列表(关键字).
	 */
	public Pager<ImageMes> getImageMessByMarkcode(String wxid, Integer count, String markcode);
