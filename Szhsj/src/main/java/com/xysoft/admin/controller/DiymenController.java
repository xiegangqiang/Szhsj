...
public class DiymenController extends BaseController {
	...
	@RequestMapping(params = "wxinfo")
	public String info(HttpServletResponse response, HttpServletRequest request) 
			throws IOException {
		String res = this.diymenService.getWx();
		response.getWriter().print(res);
		return null;
	}
	
	@RequestMapping(params = "wxconfig")
	public String wxconfig(HttpServletResponse response, HttpServletRequest request, 
			Wx param) throws IOException {
		String res = this.diymenService.configWx(param);
		response.getWriter().print(res);
		return null;
	}
