...
public class ClassifyServiceImpl implements ClassifyService {
	...
	public String getClassifys(PageParam page, String name) {
		Pager<Classify> pager = this.classifyDao.getClassifys(page, name, RequestUtil.getWeiXinId());
	...
	public String saveClassify(Classify param) {
		...
		if (!"".equals(param.getId())) {
			...
			classify.setWx(RequestUtil.getWeiXinId());
		}
		BeanUtils.copyProperties(param, classify, new String[]{"id", "wx","createDate"});
